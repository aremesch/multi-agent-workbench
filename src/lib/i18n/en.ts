...
const en = {
  ...
  'sidebar.noTasks': 'No open tasks.',
  'sidebar.allAgents': 'View agents across all repositories',
  ...
  'queue.filteredByRepo': 'Showing tasks for {repo}',
  'queue.showAll': 'Show all repositories',
  ...
  'queue.action.rowMenu': 'Task actions',
  ...
  'queueAttachments.error.tooMany': 'At most 10 images per task.',
  'queueAttachments.partialFailure':
    'Task saved, but {count} attachment(s) failed to upload — edit the task to retry.',
