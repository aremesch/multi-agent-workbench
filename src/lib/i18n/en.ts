...
const en = {
  ...
  'queue.empty': 'No queued tasks yet.',
  'queue.action.create': 'New entry',
  'queue.action.addToQueue': 'Add to queue',
  ...
  'queue.field.scheduledForHint': 'Optional. The entry stays blocked until this time.',
  ...
  'queue.field.dependsOnHint':
    'This entry stays blocked until every selected entry has finished successfully.',
  'queue.field.dependsOnEmpty': 'No other queued entries to depend on yet.',
  'queue.confirmCancel.title': 'Cancel queue entry',
  'queue.confirmCancel.body':
    'This will mark the entry as cancelled and, if it is currently running, stop its agent.',
  'queue.confirmCancel.confirm': 'Cancel entry',
  'queue.confirmCancel.cancel': 'Keep',
  'queue.error.notFound': 'Queue entry not found',
  'queue.error.notEditable': 'This entry can no longer be edited',
  'queue.error.dependsOnSelf': 'An entry can’t depend on itself',
  'queue.error.unknownDependency': 'One or more dependencies were not found',
  'queue.error.loadFailed': 'Failed to load queue entries',
  'queue.error.saveFailed': 'Failed to save queue entry',
  'queue.lastError': 'Last error: {message}',
  'queue.settings.title': 'Queue concurrency',
  'queue.settings.maxGlobal': 'Max queue agents running globally',
